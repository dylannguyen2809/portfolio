 ...
 *  Adapted by Dylan Nguyen and Scout Hollyman on 27/4/19
 *  Copyright 2019 Licensed under Creative Commons SA-BY-NC 3.0.
 *
 */
...
//extracts coordinates from a HTTP request
int extractCoordinates(char *request, complex *centre, int *zoom) {
